...
      className="relative min-h-[900px] md:min-h-[900px] w-full overflow-hidden"
...
        className="relative z-10 flex min-h-[900px] md:min-h-[1000px] w-full flex-col items-center justify-center text-center text-white px-6 pt-20 md:pt-24"
